...
class Landing : Fragment() {
    ...
    private fun changeLoginSubStringColor()
    {
        ...
        spannableString.setSpan(ForegroundColorSpan(id.toColorInt()),25,31,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
    ...
    private fun changePrivacyTermsSubStringColor()
    {
        ...
        val spannableString = SpannableString(tvText)
        val id = resources.getString(R.color.twitter)
        spannableString.setSpan(ForegroundColorSpan(id.toColorInt()),31,37,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableString.setSpan(ForegroundColorSpan(id.toColorInt()),38,53,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        spannableString.setSpan(ForegroundColorSpan(id.toColorInt()),59,tvText.length-1,Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
